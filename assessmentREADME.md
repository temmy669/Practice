...
- For development: Session-based authentication via Django admin login
- For testing: Test users created in fixtures, authenticated via DRF's `force_authenticate()`
